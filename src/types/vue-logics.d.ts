...
export namespace Flowy {
  export interface FlowyElementConstructor {
    new(canvas: HTMLDivElement, onGrab: ((block: HTMLDivElement) => any) | undefined, onRelease: (() => any) | undefined, onSnap: ((block: HTMLDivElement, first?: boolean, parent?: Block.BlockInterface) => any) | undefined, spacingX: number, spacingY: number);
  }
  export interface FlowyElementInterface {
    ...
    onSnap: ((block: HTMLDivElement, first?: boolean, parent?: Block.BlockInterface | undefined) => any) | undefined;
    import: ((data: any) => void) | undefined;
    output: (() => any) | undefined;
    deleteBlocks: (() => void) | undefined;

    engine: (document: Document, canvas: Canvas.CanvasInterface, onGrab: ((block: HTMLDivElement) => any) | undefined, onRelease: (() => any) | undefined, onSnap: ((block: HTMLDivElement, first?: boolean, parent?: Block.BlockInterface | undefined) => any) | undefined) => void;
  }
}
