...
class Canvas implements Logics.Canvas.CanvasInterface {
  ...
  spacingX: number;
  spacingY: number;
  state: Logics.Canvas.State;
  blocks: Logics.Block.BlockInterface[];
  ...
  draggedElement: Logics.BlockElement.BlockElementInterface | null;
  draggedTree: Logics.Block.BlockInterface[];
  ...
  groupDraggedTree = () => {
    ...
    const allBlocks: Logics.Block.BlockInterface[] = [];
